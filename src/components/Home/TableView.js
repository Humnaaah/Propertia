...
const TableView = ({data}) =>{
  ...
  const columns = [
    ...
    return  clickedItem ? <DetailUI data={itemData}/> : <Table columns={columns} pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '20', '30']}}  dataSource={data} onRow={(r) => ({
      onClick: () => getDetail(r)})} />
}
